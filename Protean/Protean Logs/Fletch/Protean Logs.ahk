...
ConfigError(){
	...
	IniRead, x1, Config.ini, Fletch logs icon, xmin
	IniRead, x2, Config.ini, Fletch logs icon, xmax
	IniRead, y1, Config.ini, Fletch logs icon, ymin
	IniRead, y2, Config.ini, Fletch logs icon, ymax
	if (x1 = "" or x2 = "" or y1 = "" or y2 = "")
	{
		Run %A_ScriptDir%\Config.ini
		GuiControl,,ScriptRed, CONFIG		
		GuiControl,,State2, ERROR
		MsgBox, 4112, Config Error, Please enter valid coordinates for [Fletch logs icon] in the config.
		reload
	}
...
IniRead, allContents, Config.ini
excludedSections := "|Sleep Brief|Sleep Normal|Sleep Short|sleep fletch|Fletch logs icon|"
