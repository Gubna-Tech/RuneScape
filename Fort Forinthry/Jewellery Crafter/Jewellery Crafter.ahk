...
Loop, % runcount
{
	...
	If (firstrun = 0)
	{
		...
		Log("BAR HOVER", "Section=" bar " | X=" x " Y=" y)
		...
		Log("SCROLL", "WheelDown count=" ScrollRand)
		...
		Log("BAR CLICK", "Section=" bar " | X=" x " Y=" y)
	...
	If (firstrun = 0)
	{
		...
		Log("SLEEP CRAFT WAIT", "Sleep completed: " SleepAmount " ms")
	}
}
