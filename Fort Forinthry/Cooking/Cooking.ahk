...
Loop, % runcount
{
	...
	If (option = "true")
	{
		...
		If (RandomNumber <= chance && PortableRemainingTime >= rs2)
		{
			++sleepcount
			...
			Log("RANDOM SLEEP", "Sleep=" RandomSleepAmount " ms | Chance=" chance "% | Roll=" RandomNumber " | PortableRemainingTime=" PortableRemainingTime " ms")
		...
		Else
		{
			Log("RANDOM SLEEP SKIPPED", "Chance=" chance "% | Roll=" RandomNumber " | PortableRemainingTime=" PortableRemainingTime " ms | Required=" rs2 " ms")
		}
	}
	Else
	{
	...
	Log("SLEEP COOK WAIT", "Sleep completed: " SleepAmount " ms")
}
