...
IniRead, option, Config.ini, Timer One, option
StringLower, option, option

if (option = "true")
{
	IniRead, sa1, Config.ini, Timer One, min
	IniRead, sa2, Config.ini, Timer One, max
	Random, SleepAmount, %sa1%, %sa2%
	SetTimer, TimerOne, %SleepAmount%
}

IniRead, option, Config.ini, Timer Two, option
StringLower, option, option

if (option = "true")
{
	IniRead, sa1, Config.ini, Timer Two, min
	IniRead, sa2, Config.ini, Timer Two, max
	Random, SleepAmount, %sa1%, %sa2%
	SetTimer, TimerTwo, %SleepAmount%
}
