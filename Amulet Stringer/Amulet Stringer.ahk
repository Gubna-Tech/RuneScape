...
{ 	
	...
	if (x1 = "" or x2 = "" or y1 = "" or y2 = "")
	{
		...
		GuiControl,,ScriptRed, %scriptname%		
		GuiControl,,State2, ERROR
		MsgBox, 48, Config Error, Please enter valid coordinates for [Amulet] in the config.
		return
	}
	Random, x, %x1%, %x2%
	Random, y, %y1%, %y2%
	...
	if (x1 = "" or x2 = "" or y1 = "" or y2 = "")
	{
		...
		GuiControl,,ScriptRed, %scriptname%		
		GuiControl,,State2, ERROR
		MsgBox, 48, Config Error, Please enter valid coordinates for [Ball of Wool] in the config.
		return
	}
	Random, x, %x1%, %x2%
	Random, y, %y1%, %y2%
