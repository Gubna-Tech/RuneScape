...
Loop, %runcount%
{
	If firstrun = 0
	{
		...
		; Selects a random point inside the configured Bank Prime coordinates.
	...
	If firstrun = 0
	{
		...
		; Selects a random point inside the configured Range coordinates.
		...
		; Waits for the configured Walk delay.
		...
		; Sends Space to continue the action.
		Send, {Space}
		
		Log("SPACE", "Space key sent")
		
		; Waits for the configured Cook delay.
		...
		; Selects a random point inside the configured Bank Main coordinates.
