...
; Executes the configured number of runs. Each run sends the configured
; Skillbar hotkey, performs the configured short sleep, optionally performs
; a randomized sleep based on the configured chance, sends Space, and then
; performs the configured Fletch sleep.
Loop, %runcount%
{
++count
++count2
