...
Switch selectedScript
{
    ...
    Case "Protean Bar - Normal":
        script := "Normal Protean"
        scriptDir := A_ScriptDir . "\protean\protean bar"
    ...
    Case "Protean Cog - Normal":
        script := "Normal Protean"
        scriptDir := A_ScriptDir . "\protean\protean Cog"
    ...
    Case "Protean Essence - Normal":
        script := "Normal Protean"
        scriptDir := A_ScriptDir . "\protean\protean Essence"
    ...
    Case "Protean Hide - Normal":
        script := "Normal Protean"
        scriptDir := A_ScriptDir . "\protean\protean Hide"
    ...
    Case "Protean Logs - Fletch - Normal":
        script := "Normal Protean"
        scriptDir := A_ScriptDir . "\protean\protean logs\fletch"
    ...
    Case "Protean Logs - Fletch/Burn - Normal":
        script := "Normal Protean"
        scriptDir := A_ScriptDir . "\protean\protean logs\fletch & burn"
    ...
    Case "Protean Memory - Normal":
        script := "Normal Protean"
        scriptDir := A_ScriptDir . "\protean\protean Memory"
    ...
    Case "Protean Plank - Normal":
        script := "Normal Protean"
        scriptDir := A_ScriptDir . "\protean\protean Plank"
    ...
    Case "Protean Protein - Normal":
        script := "Normal Protean"
        scriptDir := A_ScriptDir . "\protean\protean Protein"
    ...
    Case "Protean Shake - Normal":
        script := "Normal Protean"
        scriptDir := A_ScriptDir . "\protean\protean Shake"
    ...
    Case "Protean Trap":
        script := "Protean Trap"
        scriptDir := A_ScriptDir . "\protean\" . script
...
{
    ; Remove a trailing slash, then create the actual script path.
	ScriptDirectory := RTrim(ScriptDirectory, "\")
	FullDiskPath := ScriptDirectory . "\" . ScriptFile
	
	if !FileExist(FullDiskPath)
	{
        ; Show the path relative to the folder containing this selector script.
    ...
    ; make the selected script's own folder its working directory,
    ; so relative files such as Config.ini are found there.
