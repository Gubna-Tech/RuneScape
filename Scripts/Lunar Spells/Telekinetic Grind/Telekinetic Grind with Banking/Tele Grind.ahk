...
Loop, %runcount%
{
	...
	IniRead, saf1, Config.ini, Sleep Grind, min
	IniRead, saf2, Config.ini, Sleep Grind, max
	Random, SleepAmount, %saf1%, %saf2%
	LLARS_FinalSleep(SleepAmount)
	Log("SLEEP GRIND WAIT", "Sleep completed: " SleepAmount " ms")
