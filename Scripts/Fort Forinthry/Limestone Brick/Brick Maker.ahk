...
Run(ctx)
{
	...
	if (ctx.IsFirst)
	{
		LLARS_SetStatus("Banking", "Limestone Bricks")
		LLARS_Click("Bank Prime")

		LLARS_Sleep("Sleep Short")

		LLARS_SetStatus("Loading Preset", "Limestone Bricks")
		LLARS_PressHotkey("Bank Preset")

		LLARS_Sleep("Sleep Short")

		LLARS_SetStatus("Moving", "Stonecutter")
		LLARS_Click("Stonecutter")
	...
	LLARS_SetStatus("Cutting", "Limestone Bricks")
