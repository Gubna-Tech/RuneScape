...
if (timeToRunMinutes = "" || !RegExMatch(timeToRunMinutes, "^\d+$") || timeToRunMinutes <= 0)
{
...
; ============================================================================
; |     ANTI-AFK START     -     ANTI-AFK START     -     ANTI-AFK START     |
; ============================================================================
...
Log("ANTI-AFK WINDOW", "RuneScape window detected | X=" RSx " Y=" RSy " W=" RSw " H=" RSh)
...
Log("ANTI-AFK MOVE", "Initial mouse movement | X=" x " Y=" y " Speed=" RandomSpeed)
